...
ADD hornetq-jgroups-clustered.xml /opt/hornetq/hornetq-2.4.0.Final/config/stand-alone/clustered/hornetq-configuration.xml
...
ADD onyx-jgroups-s3ping.xml /opt/hornetq/
